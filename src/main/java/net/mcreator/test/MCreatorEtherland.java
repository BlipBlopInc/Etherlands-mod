...
public class MCreatorEtherland extends Elementstest.ModElement {
	public static int DIMID = 3;
	public static final boolean NETHER_TYPE = false;
	@GameRegistry.ObjectHolder("test:etherland")
	public static final Item block = null;
	@GameRegistry.ObjectHolder("test:etherland_portal")
	public static final BlockCustomPortal portal = null;
	public static DimensionType dtype;

	public MCreatorEtherland(Elementstest instance) {
		super(instance, 2);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ModTrigger().setUnlocalizedName("etherland").setRegistryName("etherland"));
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension etherland is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("etherland", "_etherland", DIMID, WorldProviderMod.class, true);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("test:etherland", "inventory"));
	}
	...
	public static class WorldProviderMod extends WorldProvider {
		...
		public net.minecraft.client.audio.MusicTicker.MusicType getMusicType() {
			return EnumHelperClient.addMusicType("test:Etherland",
					(net.minecraft.util.SoundEvent) net.minecraft.util.SoundEvent.REGISTRY.getObject(new ResourceLocation(("test:Etherland"))), 6000,
					24000);
		}
		...
		public Vec3d getFogColor(float par1, float par2) {
			return new Vec3d(0.447058823529, 0.501960784314, 0.298039215686);
		}
		...
		public void onPlayerAdded(EntityPlayerMP entity) {
			...
			int z = (int) entity.posZ;
			{
				...
				MCreatorEtherportalPlayerEntersDimension.executeProcedure($_dependencies);
			}
		}
	}
				...
				for (int j7 = -1; j7 <= 1; ++j7) {
					for (int l7 = 1; l7 < 3; ++l7) {
						for (int k8 = -1; k8 < 3; ++k8) {
							...
							boolean flag = k8 < 0;
							this.world.setBlockState(new BlockPos(k9, k10, k11), flag ? MCreatorEtherportal.block.getDefaultState().getBlock()
			...
			for (int i8 = 0; i8 < 4; ++i8) {
				for (int l8 = 0; l8 < 4; ++l8) {
					for (int l9 = -1; l9 < 4; ++l9) {
						...
						this.world.setBlockState(new BlockPos(l10, l11, k12), flag1 ? MCreatorEtherportal.block.getDefaultState().getBlock()
				...
				for (int j1 = -2; j1 <= 2; ++j1) {
					for (int k1 = -2; k1 <= 2; ++k1) {
						for (int l1 = -1; l1 < 3; ++l1) {
							...
							int k2 = k + k1 * 0 - j1 * 1;
							boolean flag = l1 < 0;
							this.world.setBlockState(new BlockPos(i2, j2, k2), flag ? MCreatorEtherportal.block.getDefaultState().getBlock()
									.getDefaultState() : Blocks.AIR.getDefaultState());
						}
					}
				}
	...
	public static class BlockCustomPortal extends BlockPortal {
		public BlockCustomPortal() {
			setHardness(-1.0F);
			setUnlocalizedName("etherland_portal");
			setRegistryName("etherland_portal");
			setLightLevel(0F);
		}
		...
		private void portalDestroyed(World world, BlockPos pos) {
			...
			int z = pos.getZ();
			{
				...
				MCreatorEtherlandOnPortalDestroyed.executeProcedure($_dependencies);
			}
		}
		...
		public static class Size {
			...
			protected int getDistanceUntilEdge(BlockPos p_180120_1_, EnumFacing p_180120_2_) {
				...
				for (i = 0; i < 22; ++i) {
					...
					if (!this.isEmptyBlock(this.world.getBlockState(blockpos).getBlock())
							|| this.world.getBlockState(blockpos.down()).getBlock() != MCreatorEtherportal.block.getDefaultState().getBlock()) {
						break;
					}
				}
				Block block = this.world.getBlockState(p_180120_1_.offset(p_180120_2_, i)).getBlock();
				return block == MCreatorEtherportal.block.getDefaultState().getBlock() ? i : 0;
			}
			...
			protected int calculatePortalHeight() {
				label56 : for (this.height = 0; this.height < 21; ++this.height) {
					for (int i = 0; i < this.width; ++i) {
						...
						if (i == 0) {
							...
							if (block != MCreatorEtherportal.block.getDefaultState().getBlock()) {
								break label56;
							}
				...
				for (int j = 0; j < this.width; ++j) {
					if (this.world.getBlockState(this.bottomLeft.offset(this.rightDir, j).up(this.height)).getBlock() != MCreatorEtherportal.block
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		private static final IBlockState STONE = MCreatorEther.block.getDefaultState();
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("test:etherlandbiome1")),
				Biome.REGISTRY.getObject(new ResourceLocation("test:etherlandbiome2")),};
